...
var file_contract_protobuf_messages_message_proto_goTypes = []interface{}{
...
func file_contract_protobuf_messages_message_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_contract_protobuf_messages_message_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_contract_protobuf_messages_message_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
